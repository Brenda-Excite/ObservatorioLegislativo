    ...
    <Modal show={open} onHide={handleClose}>
      <Form onSubmit={handleSubmit(onSubmit)}>
        <Modal.Header closeButton>
          <Modal.Title> {"Editar Partido Político"}</Modal.Title>
        </Modal.Header>
        <Modal.Body>
          <Form.Group>
            <ImageUploader
          ...
          <Form.Group>
            ...
            <Form.Control
              ...
              defaultValue={politicalSelected?.name ? politicalSelected.name : ""}
            />
          ...
          <Form.Group>
            ...
            <Form.Control
              ...
              defaultValue={politicalSelected?.abbreviation ? politicalSelected.abbreviation : ""}
            />
          ...
          <Form.Group>
            ...
            <Form.Control
              ...
              defaultValue={politicalSelected?.ideology ? politicalSelected.ideology : ""}
            />
